...
export interface LessonContent {
  ...
  // Spanish-only TTS script generated by scripts/generate-lesson-audio.mjs.
  // Reads each item aloud + ends with one short example sentence. The
  // lesson handler sends this as audio after the text, available to all
  // plans (curriculum is pre-generated + cached, not on-demand).
  audio_script?: string;
}
